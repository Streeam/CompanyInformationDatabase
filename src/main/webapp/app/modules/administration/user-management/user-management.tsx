...
import { getUsers, updateUserAndCreateEmployee } from './user-management.reducer';
...
export class UserManagement extends React.Component<IUserManagementProps, IPaginationBaseState> {
  ...
  toggleActive = user => () => {
    this.props.updateUserAndCreateEmployee({
      ...user,
...
const mapDispatchToProps = { getUsers, updateUserAndCreateEmployee };
