            ...
            <Table responsive aria-describedby="employee-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('hiredDate')}>
                    Hired Date <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {employeeList.map((employee, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{employee.user.id ? employee.user.id : ''}</td>
                    <td>{employee.role.id ? <Link to={`roles/${employee.role.id}`}>{employee.role.id}</Link> : ''}</td>
