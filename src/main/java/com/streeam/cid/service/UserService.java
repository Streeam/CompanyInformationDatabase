...
import com.streeam.cid.config.Constants;
...
import com.streeam.cid.service.util.RandomUtil;
...
public class UserService {
    ...
    public Optional<User> activateRegistration(String key) {
        ...
        return userRepository.findOneByActivationKey(key)
            .map(user -> {
                ...
                Employee newEmployee = employeeService.createEmployeeFromUser(user);
                notificationService.save("System", newEmployee, NotificationType.WELCOME, "Welcome to CID.");
                return user;
            });
    }
    ...
    public Optional<UserDTO> updateUserAndCreateEmployee(UserDTO userDTO) {
