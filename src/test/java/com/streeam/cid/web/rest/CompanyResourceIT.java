...
public class CompanyResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "2@#q.P%";
    private static final String UPDATED_EMAIL = "4[@e.UE";
    ...
    public void setup() {
        ...
        final CompanyResource companyResource = new CompanyResource(companyService, mailService);
