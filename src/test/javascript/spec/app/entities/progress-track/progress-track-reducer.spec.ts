...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_PROGRESSTRACK_LIST), REQUEST(ACTION_TYPES.FETCH_PROGRESSTRACK)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PROGRESSTRACK),
          REQUEST(ACTION_TYPES.UPDATE_PROGRESSTRACK),
          REQUEST(ACTION_TYPES.DELETE_PROGRESSTRACK)
        ],
        {},
        state => {
          expect(state).toMatchObject({
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_PROGRESSTRACK_LIST),
          FAILURE(ACTION_TYPES.FETCH_PROGRESSTRACK),
          FAILURE(ACTION_TYPES.CREATE_PROGRESSTRACK),
          FAILURE(ACTION_TYPES.UPDATE_PROGRESSTRACK),
          FAILURE(ACTION_TYPES.DELETE_PROGRESSTRACK)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_PROGRESSTRACK),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_PROGRESSTRACK_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_PROGRESSTRACK actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_PROGRESSTRACK)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_PROGRESSTRACK),
          payload: resolvedObject
