...
import reducer, {
  ...
  updateEntity,
  reset
} from 'app/entities/after-sale-expenses/after-sale-expenses.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_AFTERSALEEXPENSES_LIST), REQUEST(ACTION_TYPES.FETCH_AFTERSALEEXPENSES)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_AFTERSALEEXPENSES),
          REQUEST(ACTION_TYPES.UPDATE_AFTERSALEEXPENSES),
          REQUEST(ACTION_TYPES.DELETE_AFTERSALEEXPENSES)
        ],
        {},
        state => {
          expect(state).toMatchObject({
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_AFTERSALEEXPENSES_LIST),
          FAILURE(ACTION_TYPES.FETCH_AFTERSALEEXPENSES),
          FAILURE(ACTION_TYPES.CREATE_AFTERSALEEXPENSES),
          FAILURE(ACTION_TYPES.UPDATE_AFTERSALEEXPENSES),
          FAILURE(ACTION_TYPES.DELETE_AFTERSALEEXPENSES)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_AFTERSALEEXPENSES),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_AFTERSALEEXPENSES_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_AFTERSALEEXPENSES actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_AFTERSALEEXPENSES)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_AFTERSALEEXPENSES),
          payload: resolvedObject
