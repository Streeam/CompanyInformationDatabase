...
describe('Company e2e test', () => {
  ...
  it('should load create Company page', async () => {
    ...
    expect(await companyUpdatePage.getPageTitle().getText()).to.match(/Create or edit a Company/);
  ...
  it('should create and save Companies', async () => {
    async function createCompany() {
      ...
      await companyUpdatePage.setOverheadRateInput('5');
      expect(await companyUpdatePage.getOverheadRateInput()).to.eq('5');
      await companyUpdatePage.setLinkedinInput('linkedin');
      expect(await companyUpdatePage.getLinkedinInput()).to.match(/linkedin/);
      await companyUpdatePage.setFacebookInput('facebook');
      expect(await companyUpdatePage.getFacebookInput()).to.match(/facebook/);
      await companyUpdatePage.setTwitterInput('twitter');
      expect(await companyUpdatePage.getTwitterInput()).to.match(/twitter/);
