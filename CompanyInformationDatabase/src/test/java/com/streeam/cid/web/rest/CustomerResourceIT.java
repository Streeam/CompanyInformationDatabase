...
import com.streeam.cid.domain.Customer;
import com.streeam.cid.repository.CustomerRepository;
import com.streeam.cid.service.CustomerService;
import com.streeam.cid.service.dto.CustomerDTO;
import com.streeam.cid.service.mapper.CustomerMapper;
...
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_CUSTOMER_CURENCY = "AAAAAAAAAA";
    private static final String UPDATED_CUSTOMER_CURENCY = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .customerCurency(DEFAULT_CUSTOMER_CURENCY)
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .customerCurency(UPDATED_CUSTOMER_CURENCY)
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerCurency()).isEqualTo(DEFAULT_CUSTOMER_CURENCY);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerCurency").value(hasItem(DEFAULT_CUSTOMER_CURENCY)))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.customerCurency").value(DEFAULT_CUSTOMER_CURENCY))
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerCurency()).isEqualTo(UPDATED_CUSTOMER_CURENCY);
