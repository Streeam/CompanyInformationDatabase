...
/**
 * REST controller for managing {@link com.streeam.cid.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    /**
     * {@code POST  /customers-batch} : Save multiple customers in batches.
     *
     * @param list of customers to save.
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/customers/batches")
    public ResponseEntity<Void> createCustomersInBatches(@RequestBody List<CustomerDTO> list) throws URISyntaxException {
        log.warn("Size - ",list.size());
        customerService.saveInBatch(list);
